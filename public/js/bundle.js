    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "lobby"}, 
                React.createElement("h1", null, "lobby"), 
                React.createElement("h2", null, "Games:"), 
                React.createElement("ul", null, 
                    games.map(function(game) {
                        return React.createElement("li", null, game.id);
                    })
                ), 
                React.createElement("h2", null, "Players:"), 
                React.createElement("ul", null, 
                    players.map(function(player) {
                        return React.createElement("li", null, player.id);
                    })
                )
            )
        );
    ...
    render: function () {
        ...
        switch (playerInfo.state) {
            case config.playerInfoStates.connecting:
                playerInfoDivContent = React.createElement("div", {className: "playerInfo"}, "Connecting...");
                break;
            case config.playerInfoStates.identifying:
                playerInfoDivContent = React.createElement("div", {className: "playerInfo"}, "Identifying...");
                break;
            case config.playerInfoStates.inLobby:
                playerInfoDivContent = React.createElement("div", {className: "playerInfo"}, playerInfo.name, " (", playerInfo.id, ") ", React.createElement("a", {href: "#", onClick: this.resetName}, "change name"));
                break;
            default:
        ...
        var mainDivContent = function() {
            switch(playerInfo.state){
                case config.playerInfoStates.inLobby:
                    return React.createElement(Lobby, React.__spread({},  state.lobby));
                default:
                    return "";
            }
        };
        ...
        return (
            React.createElement("div", {id: "stockfighter-player"}, 
                React.createElement("div", {id: "player-info"}, 
                    playerInfoDivContent
                ), 
                React.createElement("div", {id: "main"}, mainDivContent())
            )
        );
...
},{"./../config":4,"./Lobby.react":1,"react":163,"react-cookie":7}],3:[function(require,module,exports){
"use strict";
    ...
    render: function () {
        ...
        switch(mode){
            case config.modes.singlePlayer:
                return React.createElement(Player, null);
                
        }

        return React.createElement("div", null, "Cannot render mode ",  mode );
    }
});

},{"./../config":4,"./Player.react.js":2,"react":163}],4:[function(require,module,exports){
"use strict";
...
},{"cookie":8}],8:[function(require,module,exports){
/*!
 * cookie
...
React.render(
  React.createElement(StockFighterApp, React.__spread({},  initialState)),
  document.getElementById("react-app")
);

},{"./client/StockFighterApp.react":3,"react":163}]},{},[164]);
